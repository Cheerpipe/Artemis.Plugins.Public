...
{
    public class LogitechCustomRgbDevice : AbstractRGBDevice<LogitechCustomRgbDeviceInfo>, IMouse, IMousepad
    {
        internal LogitechCustomRgbDevice(LogitechCustomRgbDeviceInfo info, IUpdateQueue updateQueue, int ledCount)
