...
namespace Artemis.Plugins.LayerBrushes.Shuffle.LayerProperties.Presets
{
    public class Artemis : ILayerBrushPreset
    {
        ...
        public void Apply()
        {
            ...
            gradient.Add(new ColorGradientStop(new SKColor(255, 109, 0), 0));
            gradient.Add(new ColorGradientStop(new SKColor(239, 23, 136), 0.33f));
            gradient.Add(new ColorGradientStop(new SKColor(236, 5, 166), 66f));
            gradient.Add(new ColorGradientStop(new SKColor(0, 252, 204), 1f));
