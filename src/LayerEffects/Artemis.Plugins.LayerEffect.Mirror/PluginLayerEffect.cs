...
using Artemis.Plugins.LayerEffect.Mirror.PropertyGroups;
using SkiaSharp;

namespace Artemis.Plugins.LayerEffect.Mirror
{
    public class MirrorPluginLayerEffect : LayerEffect<MainPropertyGroup>
    {
        ...
        public override void PreProcess(SKCanvas canvas, SKRect renderBounds, SKPaint paint)
        {
            ...
            //canvas.Clear();
            //canvas.Restore();
            //canvas.Scale(-1, 1, renderBounds.Width / 2.0f, 0);
            //canvas.Translate(renderBounds.Width / 2, 0);
            ...
            */
            ...
            //  canvas.Translate(renderBounds.Width, 0);
        ...
        {
            var colors = new[] { SKColors.Red, SKColors.Yellow };
